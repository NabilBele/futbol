...
<div class="Reservation">
    ...
    <?= $form->field($model, 'idSocio')->dropDownList([$socio->id => $socio->nombre],
     ['readonly' => true]) ?>

    <?= $form->field($model, 'idCampo')->dropDownList([$campo->id => $campo->nombre],
     ['readonly' => true]) ?>
...
?>
    ...
    <?= $form->field($model, 'personas')->textInput(['readonly' => true, 'value' => $campo->aforo]) ?>
